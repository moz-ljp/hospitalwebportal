<?php
require("navbar.php");
include_once("phpFunctions/patient_book_appointment.php");

if(isset($_POST['submit']))
{
    $date = $_GET['date'];
    
    $result = makeAppointment($_SESSION['patientAccount']['Username'], $_POST['details'], $date);

    header("Location: patientPortal.php?booked=true");
