...
if(isset($_POST['submit']) and $loggedIn)
{
    ...
    if($result == 1)
    {
        header("Location: patientPortal.php?cancelled");
    }
    else
    {
        header("Location: patientPortal.php?failed");
    }
}
...
<div class="main">
    ...
    <form method="post" autocomplete="on" >
        ...
        <button name="submit" class="btn btn-danger">Cancel your Appointment</button></center>
