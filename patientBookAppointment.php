...
if($loggedIn and isset($_POST['submit']))
{
   ...
   {
    header("Location: patientPortal.php?inpast=true");
   }
                ...
                <table class="styled-table" style="margin-left:auto; margin-right:auto">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            ?>
                            <td><?php echo $time?></td>
                            <td><a class="btn btn-success" href="confirmAppointment.php?date=<?php echo $appointmentArray[$i][3]?>;" style="height:30px; font-size:15px;">Book</a></td>
                        </tr>
                        <?php }}}?>
                    </tbody>
                </table>
